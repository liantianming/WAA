...
public class ConvertVideo {
    ...
    private static String inputPath = "C:\\Users\\lzf85\\Desktop\\earyUI\\01.01_计算机基础(计算机概述).avi";

    private static String outputPath = "D:\\androidProject1\\xxxcxy-support-generator-master\\Video\\target\\Video-1.0-SNAPSHOT\\video\\";

    private static String ffmpegPath = "C:\\Users\\lzf85\\Desktop\\earyUI\\ffmpeg-20171225-be2da4c-win64-static (1)\\ffmpeg-20171225-be2da4c-win64-static\\bin\\";
...
//                    + outputPath + "a.flv");
    ...
    private static boolean processMp4(String oldfilepath) {
        ...
        // ffmpeg -i oldfilepath -c:v libx264 -mbd 0 -c:a aac -strict -2 -pix_fmt yuv420p -movflags faststart a.mp4
        command.add(ffmpegPath + "ffmpeg");
        command.add("-i");
        command.add(oldfilepath);
        command.add("-c:v");
